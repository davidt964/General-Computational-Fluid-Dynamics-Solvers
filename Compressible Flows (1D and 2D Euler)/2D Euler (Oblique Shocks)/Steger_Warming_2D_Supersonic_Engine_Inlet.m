...
% AUTHOR: David L. Tran
%
% Steger-Warming method ONLY for this script
%
% DESCRIPTION: Solves the Steger-Warming original scheme for a 2D
% supersonic engine inlet with prescribed supersonic inlet conditions. A
% grid is generated using the differential equation method which uses an
