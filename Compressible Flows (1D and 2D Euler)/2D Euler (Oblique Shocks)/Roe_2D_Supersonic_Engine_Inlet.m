...
% AUTHOR: David L. Tran
%
% MAE 250D Final Project (Roe's method ONLY for this script)
%
% DESCRIPTION: Solves Roe's original scheme for a 2D supersonic engine
% inlet with prescribed supersonic inlet conditions. A grid is generated
% using the differential equation method which uses an algebraically
% generated grid as an initial guess. The numerical approximation is
% repeated until convergence within a set tolerance is desired.
%
%==========================================================================
